...
class TestAddEmployee:
    ...
    def test_validate_add_employee(self):
        ...
        add_emp.enter_employee_details("janath", "raju", "jasna", "10001")  # Enter employee details
        add_emp.toggle_create_login_details()  # Toggle the switch to create login details
        add_emp.enter_login_details("jasukutt07", "Test@1234", "Test@1234")  # Enter login details for the new employee
